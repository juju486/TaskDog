      ...
      <el-table-column label="操作" width="320" fixed="right">
        <template #default="{ row }">
          <div class="action-buttons">
            <el-button size="small" @click="$emit('test', row)" class="action-btn">
...
<style scoped>
.table-container { background: white; border-radius: 8px; box-shadow: 0 2px 12px 0 rgba(0,0,0,0.1); }
.script-name { display: flex; align-items: center; }
.script-icon { margin-right: 8px; color: #409EFF; }
